...
import com.example.foodrecipeapp.retofitclient.RetrofitClientInstance
...
class DetailActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        id_btnYoutube.setOnClickListener {
            val uri: Uri =
    ...
    fun getSpecificItem(id:String){
        ...
        call.enqueue(object : Callback<MealResponse>{
            ...
            override fun onResponse(
                ...
                id_tvCategory.text = response.body()!!.mealsEntity[0].strmeal
                ...
                id_tvIngredients.text = ingredient
                id_tvIntructions.text = response.body()!!.mealsEntity[0].strinstructions

                if (response.body()!!.mealsEntity[0].strsource != null){
                    youtubeLink = response.body()!!.mealsEntity[0].strsource
                }else{
                    id_btnYoutube.visibility = View.GONE
                }
            }
